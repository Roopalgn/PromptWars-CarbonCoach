      ...
      <main id="main-content" className="landing" aria-label="CarbonCoach welcome page">
        ...
        <section className="landing-hero" aria-labelledby="hero-headline">
          ...
          <h1 id="hero-headline" className="hero-headline">
            ...
            <br />
            <em style={{ fontStyle: 'normal', color: 'var(--text-secondary)' }}>Know yours.</em>
          </h1>
          ...
          {authError && (
            <p className="form-error" role="alert" aria-live="assertive" style={{ marginTop: 'var(--s-4)', maxWidth: 360 }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          ...
          <div className="hero-stats" aria-label="App highlights">
            ...
            <div className="hero-stat-divider" aria-hidden="true" />
            <div className="hero-stat">
              <div className="hero-stat-val" style={{ color: 'var(--c-cyan)' }}>
            ...
            <div className="hero-stat-divider" aria-hidden="true" />
            <div className="hero-stat">
              <div className="hero-stat-val" style={{ color: 'var(--c-accent)' }}>
                AI
              </div>
        ...
        >
          <RevealCard>
            <div style={{ textAlign: 'center', marginBottom: 'var(--s-4)' }}>
              <div className="label-tag label-tag--green" style={{ margin: '0 auto var(--s-4)' }}>
                Features
              </div>
              <h2 id="features-heading" className="heading-lg" style={{ color: 'var(--text-primary)' }}>
                Built for <span className="text-gradient-green">India's commuters</span>
              </h2>
              <p style={{ color: 'var(--text-secondary)', marginTop: 'var(--s-3)', maxWidth: 520, margin: 'var(--s-3) auto 0' }}>
        ...
        {/* ── Footer note ──────────────────────────────── */}
        <footer style={{ textAlign: 'center', padding: 'var(--s-10) var(--s-6)', borderTop: '1px solid var(--glass-border)' }}>
